...
class CorrelationResponse(BaseModel):
    ...
    to: StrictStr
    results: List[CorrelationResponseResultsInner]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["base", "from", "to", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "from": obj.get("from"),
            "to": obj.get("to"),
            "results": [CorrelationResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
