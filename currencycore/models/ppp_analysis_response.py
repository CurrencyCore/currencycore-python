...
class PppAnalysisResponse(BaseModel):
    """
    PppAnalysisResponse
    """ # noqa: E501
    ...
    stats: StrictBool
    results: List[PppAnalysisResponseResultsInner]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["from", "to", "mode", "sort", "stats", "results"]
    ...
    def sort_validate_enum(cls, value):
        ...
        if value not in set(['increased', 'decreased']):
            raise ValueError("must be one of enum values ('increased', 'decreased')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sort": obj.get("sort"),
            "stats": obj.get("stats"),
            "results": [PppAnalysisResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
