...
class MeanReversionResponse(BaseModel):
    ...
    results: List[MeanReversionResponseResultsInner]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["base", "from", "to", "universe", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [MeanReversionResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
